...
export function parseAdminOperation(options) {
  ...
  if (namespace === "runtime-logs") {
    ...
    throw cliValidationError(
      "Usage: lumine admin runtime-logs start | status|read --review-session <file> | finish --review-session <file> --reviewed.",
    );
  }
  ...
  throw cliValidationError(
    "Usage: lumine admin identity|economy|rescue|sponsor|daily-run|escalation|todo|recommendations|builds|post|subjects|subject|featured|comment|announcement|chat|news|audit|brief|ai-costs|media-costs|runtime-logs|bot-output|notable ...",
  );
}
