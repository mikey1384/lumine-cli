...
export function parseAdminOperation(options) {
  ...
  throw cliValidationError(
    "Usage: lumine admin identity|economy|rescue|daily-run|escalation|todo|recommendations|builds|post|subjects|subject|featured|comment|announcement|chat|news|audit|brief|ai-costs|bot-output|notable ...",
  );
}
