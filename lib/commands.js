...
export function printHelp() {
  ...
  lumine admin builds candidates [--cursor <cursor>] [--limit <number>] [--json]
  ...
  lumine admin comment draft <target> [--type subject|comment|build|aiStory|dailyReflection] [--file <comment.md>] [--reviewed-version <id> --reviewed-via runtime|code] [--identity zero|ciel|auto] [--json]
