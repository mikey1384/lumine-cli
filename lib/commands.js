...
export async function main() {
  ...
  if (options.command === "sponsor") {
    await sponsorCommand(options, {
      ...
      updateFromMain: updateBranchFromMain,
      uploadAssets: assetsUpload,
      notifyOwner: notifyBuildOwnerOfContribution,
      suggestThumbnail: suggestBuildThumbnailToOwner,
      thumbnailCommand,
      renameBuild,
      describeBuild,
    });
...
export function parseArgs(args) {
  ...
  return {
    ...
    adminReviewSession: raw.reviewSession ? String(raw.reviewSession) : "",
    adminReviewed: Boolean(raw.reviewed),
    ...
    sponsorNoLeaseKeeper: Boolean(raw.noLeaseKeeper),
    sponsorHoldEverySeconds: raw.holdEverySeconds,
    sponsorUpdateFile: raw.file ? String(raw.file) : "",
    sponsorUpdatePhase: raw.phase ? String(raw.phase) : "",
    sponsorUpdateKind: raw.kind ? String(raw.kind) : "",
    sponsorResolvedModel: raw.resolvedModel ? String(raw.resolvedModel) : "",
    sponsorResolvedEffort: raw.resolvedEffort ? String(raw.resolvedEffort) : "",
...
export function printHelp() {
  ...
  lumine sponsor job update <job-id> --file <path> --kind question
...
Options:
  ...
  --config <file>       Reviewer's earning rules JSON for reward-review approve
  ...
  --include-legacy      Explicitly include full historical recommendation/Subject rows
