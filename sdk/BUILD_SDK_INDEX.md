...
Version: 1.47.0
Updated: 2026-09-21
Generated: 2026-09-21T13:19:41.014Z
...
- await Twinkle.rewards.start({ ruleId, levelIndex? }) | scopes: rewards:claim
  ...
  - For breadface-v1 and breadface-v2, pass the zero-based canonical levelIndex. Record [dt, inputBits] from the first physics frame; start returns its server token and maxFrames. For study-record-v1, start returns completion { profile, usesAiEnergy: true }; there is no client-authored proof token.
